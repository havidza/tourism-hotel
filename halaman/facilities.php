...
-->
	...
	<div id="header">
		...
		<br><br><br>
	<div class ="small">
		<h2 class="kecil">Merlin Luxury Experience</h2>
		<h1 class="besar"> FACILITIES OF MERLIN HOTEL</h1>
	</div>
	<br>
...
$result=mysql_query('SELECT * FROM fasilitas');
while ($row=mysql_fetch_array($result,MYSQL_ASSOC))

	echo "
<div class=container>
<a href=".$row['link']."> <img src=gambar/".$row['gambar']." width=100.2%></a>
